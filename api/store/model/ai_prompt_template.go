...
type AiPromptTemplate struct {
	...
	Language         string    `gorm:"column:language;type:varchar(16);not null" json:"language"`
	Ratio            string    `gorm:"column:ratio;type:varchar(16);not null;default:any" json:"ratio"`
